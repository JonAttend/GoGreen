...
1. Edit the `.env` file and make the following changes.
    1. Replace `OAUTH_CLIENT_ID` with the **Application Id** you got from the App Registration Portal.
    1. Replace `OAUTH_CLIENT_SECRET` with your client secret you got from the App Registration Portal.
